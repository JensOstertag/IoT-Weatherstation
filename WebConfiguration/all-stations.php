  ...
  <body>
    ...
    <section id="home">
      ...
      <div class="station-list">
        <?php
          $searchStations = $con->prepare("SELECT StationKey, StationName, UserName FROM WeatherStations AS a INNER JOIN Users AS b ON a.StationAuthor = b.UserID");
          ...
          if($searchStationsResult->num_rows == 0) {
            echo "<p>There are no Weather Stations registered.</p>";
          }
