<?php
  ...
  if(isset($_POST["submit"])) {
    $stationKey = $_POST["station-key"];
    header("Location: weather-station.php?id=$stationKey");
  }
?>
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <section id="home">
      ...
      <p >
        Please enter the desired Weather Station ID. <a href="home.php">Back to Home</a>
      </p>
      <form class="inspect viewport-animation viewport-bottom" method="post">
        <input type="text" name="station-key" value="" placeholder="Weather Station Key" required>
